...
public interface IWalletWriteOperations
{
    ...
    /// Creates new wallet.
    /// </summary>
    /// <param name="request">Request containing owners, initial balance, wallet type, and currency.</param>
    ...
    /// </summary>
    /// <param name="request">Request containing the wallet ID, reason, and optional suspend-until timestamp.</param>
    /// <param name="context">gRPC server call context.</param>
    ...
    /// </summary>
    /// <param name="request">Request containing the wallet ID and reason for reactivation.</param>
    /// <param name="context">gRPC server call context.</param>
    /// <returns>An empty response on success.</returns>
