...
/// <summary>
/// Handles ledger transaction cleared events by marking affected journal entries as cleared.
/// </summary>
/// <remarks>
...
/// </remarks>
public static class TransactionClearedJournalEntryHandler
{
    /// <summary>
    ...
    public static async Task Handle(LedgerTransactionCleared @event, IDocumentSession session)
    {
