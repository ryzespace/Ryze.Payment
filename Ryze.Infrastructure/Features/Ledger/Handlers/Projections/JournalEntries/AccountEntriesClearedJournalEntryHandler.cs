...
/// <summary>
/// Handles account entry cleared events by marking affected journal entries as cleared.
/// </summary>
/// <remarks>
...
/// </remarks>
public static class AccountEntriesClearedJournalEntryHandler
{
    /// <summary>
    ...
    public static async Task Handle(AccountEntriesCleared @event, IDocumentSession session)
    {
